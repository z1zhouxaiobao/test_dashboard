...
-- ==================== 公告 ====================
INSERT INTO notice (id, title, content, status, created_at) VALUES
(1, '2026 年五一假期服务安排', '五一期间技术支持热线保持 7x24 值班，紧急故障请拨打 400-800-6600。', 1, '2026-04-20 09:00:00'),
(2, '官网升级维护通知', '本周六 02:00-04:00 进行系统维护，期间门户短暂不可访问，敬请谅解。', 1, '2026-04-25 18:00:00'),
(3, '欢迎参观立冷科技液冷实验室', '预约参观请发送邮件至 visit@liquicool.com，我们提供现场演示与方案交流。', 1, '2026-05-01 10:00:00');
...
-- ==================== 反馈 ====================
INSERT INTO feedback (id, user_id, content, contact, status, reply, created_at) VALUES
(1, 2, '希望门户增加方案对比功能。', '13800000002', '已回复', '感谢建议，已纳入产品迭代计划。', '2026-04-08 10:00:00'),
(2, 3, '后台导出咨询工单时希望支持 Excel。', '13800000003', '待处理', NULL, '2026-04-15 14:20:00'),
(3, 4, '产品详情页规格参数建议做成表格。', '13800000004', '处理中', '正在改版中。', '2026-04-19 09:10:00');
...
-- ==================== 日志 ====================
INSERT INTO operate_log (id, user_id, username, action, detail, ip, created_at) VALUES
(1, 1, 'admin', '登录系统', '管理员登录成功', '127.0.0.1', '2026-04-22 09:00:00'),
(2, 1, 'admin', '更新产品', '编辑产品 LC-8000', '127.0.0.1', '2026-04-22 09:20:00'),
(3, 1, 'admin', '处理咨询', '将工单#2 设为处理中', '127.0.0.1', '2026-04-22 10:00:00'),
(4, 2, 'user1', '提交咨询', '提交 CDU 询价', '127.0.0.1', '2026-04-10 11:20:00'),
(5, 2, 'user1', '收藏产品', '收藏液冷服务器', '127.0.0.1', '2026-04-02 10:00:00'),
(6, 1, 'admin', '上传文件', '上传轮播图 carousel-3.jpg', '127.0.0.1', '2026-04-21 16:00:00');
