...
const routes = [
  ...
  { path: '/admin/login', name: 'AdminLogin', component: () => import('@/views/AdminLogin.vue'), meta: { public: true, title: '管理员登录' } },
  {
    ...
    children: [
      ...
      { path: 'products', name: 'PortalProducts', component: () => import('@/views/portal/Products.vue'), meta: { public: true, title: '解决方案' } },
      { path: 'products/:id', name: 'PortalProductDetail', component: () => import('@/views/portal/ProductDetail.vue'), meta: { public: true, title: '方案详情' } },
      { path: 'honors', name: 'PortalHonors', component: () => import('@/views/portal/Honors.vue'), meta: { public: true, title: '荣誉奖项' } },
      ...
      { path: 'news', name: 'PortalNews', component: () => import('@/views/portal/News.vue'), meta: { public: true, title: '新闻资讯' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'carousels', name: 'AdminCarousels', component: () => import('@/views/admin/Carousels.vue'), meta: { requiresAdmin: true, title: '轮播图管理' } },
      { path: 'news', name: 'AdminNews', component: () => import('@/views/admin/News.vue'), meta: { requiresAdmin: true, title: '新闻资讯' } },
      { path: 'notices', name: 'AdminNotices', component: () => import('@/views/admin/Notices.vue'), meta: { requiresAdmin: true, title: '公告通知' } },
      { path: 'technologies', name: 'AdminTechnologies', component: () => import('@/views/admin/Technologies.vue'), meta: { requiresAdmin: true, title: '核心技术' } },
      { path: 'honors', name: 'AdminHonors', component: () => import('@/views/admin/Honors.vue'), meta: { requiresAdmin: true, title: '荣誉奖项' } },
      { path: 'products', name: 'AdminProducts', component: () => import('@/views/admin/Products.vue'), meta: { requiresAdmin: true, title: '解决方案' } },
      ...
      { path: 'feedbacks', name: 'AdminFeedbacks', component: () => import('@/views/admin/Feedbacks.vue'), meta: { requiresAdmin: true, title: '用户反馈' } },
